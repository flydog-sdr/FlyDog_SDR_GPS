		   ...
		   w3_div('',
            ...
            dbgUs?
               ...
               w3_button('w3-red|margin-left:16px|' +
                  'title="CAUTION: Do not use unless git clone in\n&slash;root&slash;FlyDog_SDR_GPS has become corrupted"',
                  're-clone sources', 'console_cmd_cb',
                  'console_input_cb|cd /root; rm -rf Beagle_SDR_GPS; git clone https://github.com/flydog-sdr/FlyDog_SDR_GPS.git'),
